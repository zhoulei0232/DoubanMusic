...
var  scodevalue=decodeURIComponent(value).split('=')[0];
var spage=decodeURIComponent(value).split('=')[1]/15;
var mydata;
...
$('.btn').on('click',function(){
    scodevalue =$('.inp').val();
    window.location.href='demo02.html'+'?&'+scodevalue+'=0';
})
$('.content-boxers').on('click','li',function(){
 ...
 function page(json) {
            ...
            if (nowNum > 5 && allNum >= 10) {
                ...
                $A.href = 'demo02.html'+'?&'+scodevalue+'=0';
                $A.innerHTML = '首页';
                $Div.appendChild($A);
            }                        
            //上一页
            if (nowNum > 1) {
                var $A = document.createElement('a');
                // $A.href = 'demo02.html'+'?&'+scodevalue+'=0';
                $A.href = 'demo02.html'+'?&'+scodevalue+'='+ (nowNum - 1)*15; 
                $A.innerHTML = '上一页';
                $Div.appendChild($A);                
            }
            ...
            if (allNum <= 9) {
                for (var i = 1; i <= allNum; i++) {
                    ...
                    $A.href = 'demo02.html'+'?&'+scodevalue+'='+ i*15;
                    if (nowNum === i) {
                        $A.innerHTML = i;
                    }else {
                        $A.innerHTML = '[' + i + ']';    
                ...
                for (var i = 1; i <= 9; i++) {
                    ...
                    if (nowNum < 5) {
                        ...
                        $A.href = 'demo02.html'+'?&'+scodevalue+'=' + (allNum - 9 + i)*15;
                        // 特殊处理后4几页
                    ...
                    // 正常处理方式 以nowNum为中心 向两侧扩散 4个数
                        ...
                        $A.href = 'demo02.html'+'?&'+scodevalue+'=' + (nowNum - 5 + i)*15; 
                        if (i === 5) {
            ...
            if ( (allNum - nowNum) > 5) {
                var $A = document.createElement('a');
                $A.href = 'demo02.html'+'?&'+scodevalue+'=' + allNum*15;
                $A.innerHTML = '尾页';
                $Div.appendChild($A);                
            }
            // 下一页
